...
namespace ARMS\Integrations\Widgets;
...
class My_Recent_Posts_Widget extends \WPH_Widget {
	...
	public function __construct() { // phpcs:ignore
		$args = array(
			'label'       => \__( 'My Recent Posts Example', A_TEXTDOMAIN ),
			'description' => \__( 'My Recent Posts Widget Description', A_TEXTDOMAIN ),
			'slug'        => 'recent-posts',
		...
		$args[ 'fields' ] = array(
			...
			array(
				// Field name/label
				'name'     => \__( 'Title', A_TEXTDOMAIN ),
				// Field description
				'desc'     => \__( 'Enter the widget title.', A_TEXTDOMAIN ),
				// Field id
				'id'       => 'title',
				...
				'class'    => 'widefat',
				// Default value
				'std'      => \__( 'Recent Posts', A_TEXTDOMAIN ),
				/**
			...
			// Taxonomy Field
			array(
				'name'  => \__( 'Taxonomy', A_TEXTDOMAIN ),
				'desc'  => \__( 'Set the taxonomy.', A_TEXTDOMAIN ),
				'id'    => 'taxonomy',
				'type'  => 'taxonomy',
				'class' => 'widefat',
			),
			// Taxonomy Field
			array(
				'name'     => \__( 'Taxonomy terms', A_TEXTDOMAIN ),
				'desc'     => \__( 'Set the taxonomy terms.', A_TEXTDOMAIN ),
				'id'       => 'taxonomyterm',
				'type'     => 'taxonomyterm',
				'taxonomy' => 'category',
				'class'    => 'widefat',
			...
			// Pages Field
			array(
				'name'  => \__( 'Pages', A_TEXTDOMAIN ),
				'desc'  => \__( 'Set the page.', A_TEXTDOMAIN ),
				'id'    => 'pages',
				'type'  => 'pages',
				'class' => 'widefat',
			),
			// Post type Field
			array(
				'name'     => \__( 'Post type', A_TEXTDOMAIN ),
				'desc'     => \__( 'Set the post type.', A_TEXTDOMAIN ),
				'id'       => 'posttype',
				'type'     => 'posttype',
				'posttype' => 'post',
				'class'    => 'widefat',
			...
			// Amount Field
			array(
				'name'     => \__( 'Amount', A_TEXTDOMAIN ),
				'desc'     => \__( 'Select how many posts to show.', A_TEXTDOMAIN ),
				'id'       => 'amount',
				'type'     => 'select',
				// Selectbox fields
				'fields'   => array(
					array(
						'name'  => \__( '1 Post', A_TEXTDOMAIN ),
						'value' => '1',
					),
					array(
						'name'  => \__( '2 Posts', A_TEXTDOMAIN ),
						'value' => '2',
					),
					array(
						'name'  => \__( '3 Posts', A_TEXTDOMAIN ),
						'value' => '3',
					),
			...
			array(
				'name'   => \__( 'Output as list', A_TEXTDOMAIN ),
				'desc'   => \__( 'Wraps posts with the <li> tag.', A_TEXTDOMAIN ),
				'id'     => 'list',
				'type'   => 'checkbox',
				// Checked by default:
				'std'    => 1, // 0 or 1
	...
	public function initialize() {
		...
		'widgets_init',
		static function() {
			\register_widget( 'ARMS\Integrations\Widgets\My_Recent_Posts_Widget' );
		}
		);
	}
